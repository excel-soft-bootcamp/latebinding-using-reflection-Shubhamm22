...
namespace GameApp
{
    ...
    {
        public void Load(string pathname, string classname, string methodname, string playername)
        {
            ...
            if (nameClass != null)
            {
                if (nameClass.IsClass)
                {
                    ...
                    {
                        object advanceResult = _methodRef.Invoke(objRef, new object[] { (playername) });
